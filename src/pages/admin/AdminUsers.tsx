  ...
  return (
    <DashboardLayout>
      <div className="w-full max-w-7xl mx-auto pb-10">
        <div className="mb-6">
          <h1 className="text-2xl md:text-3xl font-bold text-deskhive-navy mb-2">User Management</h1>
          <p className="text-sm md:text-base text-deskhive-darkgray/80">
            Manage users, hub managers, and approve new account requests
          </p>
        </div>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4">
            ...
            <div className="flex gap-2">
              <Button 
                ...
                onClick={() => setFilterRole(filterRole === 'learner' ? null : 'learner')}
              >
                <Users className="h-4 w-4 mr-2" />
                {filterRole === 'learner' ? 'All Users' : 'Learners Only'}
              </Button>
              <Button 
                variant="outline" 
                className="bg-white/40 border-white/30"
              ...
              >
                ...
                {filterRole === 'hub_manager' ? 'All Users' : 'Hub Managers'}
              </Button>
            </div>
        ...
        <Card className="glass-card bg-white/20 backdrop-blur-lg border border-white/30 overflow-hidden mb-6">
          <CardHeader className="pb-3">
            ...
            <CardDescription>
              Manage all user accounts in the DeskHive platform
            </CardDescription>
          </CardHeader>
                    ...
                    <TableRow key={user.id} className="hover:bg-white/10">
                      ...
                      <TableCell>
                        <Badge variant={user.role === 'hub_manager' ? 'outline' : 'secondary'} className="capitalize">
                          {user.role === 'hub_manager' ? 'Hub Manager' : 'Learner'}
                        </Badge>
                      </TableCell>
